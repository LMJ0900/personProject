...
import { getlogin } from "./components/users/service/user.slice";
...
const HomePage : NextPage = () => {
  ...
  const getLoingMsg = useSelector(getlogin)
  ...
  const handleSubmit = () => {
    console.log('user...' + JSON.stringify(user))
      dispatch(login(user))
            ...
            useEffect(()=>{
              if(getLoingMsg === 'SUCCESS')
                {
                  router.push(`${PG.BOARD}/list`)
                }
                else if (getLoingMsg === 'FAILURE'){
                  alert('FAIL');
                }
                else if (getLoingMsg === 'WRONG PASSWORD') {
